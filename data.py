...
import cv2
import random
from utils_custom.custom_transforms import AffineScale, HueShift, SatShift
from torch.utils.data import Dataset, DataLoader
from utils_custom.settings_functions import *
from PIL import Image


# Custom histogram equalization transform
# Define a histogram equalization on an input PIL Image
class EqualizeHist(object):
    def __call__(self, x):
        assert type(x) == Image.Image, "Input not a PIL Image"
...
def define_target_samples():

    target_samples = {
        "CARBON": 2500,
        "CARBON-EMBOSSED": 2500,
        "FIBERGLASS": 5000,
        "OTHER": 5000,
        "WOVEN": 10000,
    }
